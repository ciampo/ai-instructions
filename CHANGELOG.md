...
- Use exact canonical issue and pull-request titles, preserve them through supporting workflow steps, and transition from an issue to its authored delivery pull request only when that pull request becomes the primary task. ([#95](https://github.com/ciampo/ai-instructions/pull/95), [#112](https://github.com/ciampo/ai-instructions/pull/112))
