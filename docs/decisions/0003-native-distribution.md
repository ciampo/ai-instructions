...
[OpenAI plugins for ChatGPT and Codex](https://learn.chatgpt.com/docs/build-plugins), [Claude Code plugins](https://code.claude.com/docs/en/plugins), [GitHub Copilot plugins](https://docs.github.com/en/copilot/concepts/agents/about-plugins), and [Antigravity CLI plugins](https://antigravity.google/docs/cli/plugins) provide product-specific distribution systems. Those systems can improve installation and discovery inside one product, but they do not provide one shared package format for this repository's instructions and Agent Skills.
