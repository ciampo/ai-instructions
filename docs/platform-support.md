...
7. Regenerate the README support table and review its diff.

Native plugins and extensions remain a separate distribution follow-up. They should not replace the stable source formats until their versioning, precedence, and migration behavior are equally tested.
