...
Honor a parent workflow's stricter commit, evaluation, or publication sequence. When the parent retains a later gate, return the verified fixes at the required handoff point instead of committing or pushing early.
