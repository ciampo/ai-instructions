...
9. Re-read field-limited PR metadata before concluding. If the head SHA changed, refresh the snapshot and repeat the review rather than mixing state from different heads.
