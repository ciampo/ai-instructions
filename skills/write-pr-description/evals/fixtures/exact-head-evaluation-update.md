...
Keep routine authored-PR work moving under one bounded authority contract.

## Why

Repeated authority questions interrupt exact-head review loops without changing
the action or data boundary.

## How

Separate task authority, personal standing evaluation consent, and runtime
approval controls.

## Testing Instructions

Run the focused positive and negative authority cases.

## Evaluation

Pending exact-head results.

Manual reviewer note: keep public replies outside this pull request.
```

Do not change the pull-request title, labels, reviewers, state, comments, review
threads, merge state, or release state.
