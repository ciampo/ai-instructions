...
| [iterate-pr-review](skills/iterate-pr-review/SKILL.md) | repeated Copilot and self-review loop | Bounded review iterations for authored PRs or explicitly owned fix-and-push loops |
