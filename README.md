...
| [unslop](skills/unslop/SKILL.md) | all user-facing prose, including ordinary responses and requested rewrites | Meaning-preserving writing pass that removes formulaic AI patterns |
